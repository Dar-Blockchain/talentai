...
export const compactFieldSx = {
  ...
  "& .MuiInputBase-input": { fontSize: { xs: "0.85rem", sm: "0.88rem" }, fontFamily: "Poppins" },
  "& .MuiInputBase-input::placeholder": { fontSize: { xs: "0.68rem", sm: "0.7rem" }, opacity: 1, color: "#C4CAD4" },
  "& .MuiFormHelperText-root": { fontSize: "0.7rem", mt: 0.5, fontFamily: "Poppins" },
  "& .MuiOutlinedInput-root": {
    borderRadius: "10px", fontFamily: "Poppins", fontSize: { xs: "0.85rem", sm: "0.88rem" },
    bgcolor: "#F9FAFB", height: { xs: 44, sm: 46 }, transition: "background-color 0.15s",
...
export const selectMenuProps = {
  ...
  PaperProps: {
    sx: {
      ...
      "& .MuiList-root": { py: 0.5 },
      "& .MuiMenuItem-root": {
        fontSize: { xs: "0.84rem", sm: "0.87rem", md: "0.9rem" }, py: 0.75, px: 1.5, borderRadius: 1, mx: 0.5, color: "#444", fontFamily: "Poppins", transition: "background 0.15s",
