    ...
    <Card className="p-6 mb-6 rounded-2xl shadow-none transition-shadow hover:shadow-sm">
      <div className="flex items-center gap-3 mb-1">
        <div className="w-9 h-9 rounded-lg flex items-center justify-center shrink-0" style={{ background: `${ADMIN_ACCENT}14` }}>
          <AddBusinessIcon style={{ fontSize: 18, color: ADMIN_ACCENT }} />
        </div>
        <h2 className="text-[15px] font-semibold text-slate-900">Subscribe a Company</h2>
        <Badge variant="outline" className="border-transparent font-semibold bg-indigo-50 text-indigo-600">
          Manual grant
        </Badge>
      </div>
      ...
      <div className="flex flex-wrap gap-4">
        ...
        <div className="flex-[2_1_260px] relative">
          ...
          {selectedCompany ? (
            <div className="flex items-center justify-between rounded-lg border border-indigo-300 bg-indigo-50 px-3 py-2.5">
              <div>
