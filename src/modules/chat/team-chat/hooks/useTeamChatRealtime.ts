...
import { addTeamMessage, removeTeamConversation, removeTeamMessage, upsertTeamMessage } from "@/modules/chat/team-chat/store/teamChatSlice";
...
export const useTeamChatRealtime = () => {
  ...
  useEffect(() => {
    ...
    const handleIncomingMessage = (payload: { message: any; conversationId: string }) => {
      ...
      // addTeamMessage only appends to Redux when the conversation is the one
