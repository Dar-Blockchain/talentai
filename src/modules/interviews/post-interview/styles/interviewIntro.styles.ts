...
export const SX = {
  ...
  pillTextPurple: { fontFamily: 'Poppins', fontSize: '0.72rem', color: '#16A34A', fontWeight: 600 },
  ...
  stepLabelActive:    { fontFamily: 'Poppins', fontWeight: 600, fontSize: '0.78rem', color: '#16A34A', whiteSpace: 'nowrap' },
  ...
  skillChip: { bgcolor: PURPLE_BG, color: '#16A34A', border: `1px solid ${PURPLE_BORDER}`, fontFamily: 'Poppins', fontWeight: 600, fontSize: '0.72rem' },
