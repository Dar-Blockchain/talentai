        ...
        setBars(
          Array.from({ length: BAR_COUNT }, (_, i) => {
            const h =
              3 +
              Math.abs(
                Math.sin(time + i * 0.85) * 10 +
                  Math.sin(time * 1.6 + i * 0.55) * 6,
              );
            return Math.round(h);
          }),
        );
    ...
    >
      ...
      <Box
        sx={{
          ...
          boxShadow:
            "0 0 0 3px rgba(106,211,156,0.08), 0 8px 32px rgba(0,0,0,0.18)",
        }}
      >
        <video
          ref={videoRef}
        ...
        {cameraStatus !== "granted" && (
          <Box
            sx={{
              ...
              gap: 1.75,
              background:
                "radial-gradient(ellipse at 50% 40%, #0f2e28 0%, #091918 100%)",
            }}
          >
            {cameraStatus === "requesting" ? (
              ...
              <>
                ...
                >
                  <VideocamOffIcon
                    sx={{ color: "rgba(255,255,255,0.3)", fontSize: 22 }}
                  />
                </Box>
                <Typography
                  sx={{
        ...
        {cameraStatus === "granted" && (
          <>
            ...
            {(
              ...
              <Box
                ...
                sx={{
                  ...
                  height: 16,
                  borderTop:
                    v === "top" ? "1.5px solid rgba(106,211,156,0.6)" : "none",
                  borderBottom:
                    v === "bottom"
                      ? "1.5px solid rgba(106,211,156,0.6)"
                      : "none",
                  borderLeft:
                    h === "left" ? "1.5px solid rgba(106,211,156,0.6)" : "none",
                  borderRight:
                    h === "right"
                      ? "1.5px solid rgba(106,211,156,0.6)"
                      : "none",
            ...
            {isConnecting ? (
                        ...
                        sx={{
                          ...
                          boxShadow:
                            isSpeaking && pct > 0.55
                              ...
                              : "none",
                          transition:
                            "height 0.06s ease, background 0.18s ease",
                        }}
                      />
                    );
                  })}
              ...
              >
                <MicOffIcon
                  sx={{ fontSize: 12, color: "rgba(255,255,255,0.28)" }}
                />
              </Box>
            )}
          </>
