...
const CandidateRewardsSection: React.FC = () => {
  return (
    ...
    >
      ...
      >
        Build your professional profile with blockchain-verified credentials. Every interview earns tokens and increases your visibility to top employers.
      </Typography>
      ...
      >
        ...
        >
          ...
          <Typography variant="body1" color="#888" mb={3}>
            Every interview completed earns you up to 33.33 TAI tokens based on your score.
          </Typography>
          <Box
            sx={{
        ...
        >
          ...
          <Typography variant="body1" color="#888" mb={3}>
            Receive blockchain-verified skill badges you can share on LinkedIn and your resume.
          </Typography>
        ...
        >
          ...
          <Typography variant="body1" color="#888" mb={3}>
            Higher scores = Better visibility. Companies find you based on verified skills.
          </Typography>
      ...
      <Box sx={{ textAlign: 'center', mt: 8 }}>
        ...
        <Typography variant="body1" color="#888" mb={4}>
          Join professionals who've verified their skills and advanced their careers
        </Typography>
        <Button
          variant="contained"
          size="large"
