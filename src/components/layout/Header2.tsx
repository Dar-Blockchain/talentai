...
const Header2 = ({ logo, type }: HeaderProps) => {
  ...
  useEffect(() => {
    if (type) {
      ...
      dispatch(setUserType(type as "company" | "candidate"));
    }
  }, [type, dispatch]);
        ...
        {isAuthenticated ? (
          ...
          <Stack spacing={2}>
            <Button
              ...
              sx={{
                backgroundColor: type === "candidate" ? "#BD85FF" : "#4DD9A3",
                color: "#ffffff",
                borderRadius: 999,
                textTransform: "none",
                py: 1.5,
                ...
                fontWeight: 600,
                "&:hover": {
                  backgroundColor: type === "candidate" ? "#9c5fd4" : "#3bc98a",
                },
              }}
            >
              Login
            ...
            >
              {type === "candidate" ? "Sign-up" : "Watch Demo"}
            </Button>
          </Stack>
        )}
      </Box>
              ...
              isAuthenticated && profile ? (
                ...
                <Stack direction="row" spacing={2}>
                  <Button
                    ...
                    sx={{
                      backgroundColor: "#ffffff",
                      color: type === "candidate" ? "#BD85FF" : "#4DD9A3",
                      border: "none",
                      borderRadius: 999,
                      textTransform: "none",
                      px: 2,
                  ...
                  <Button
                    variant="outlined"
                    onClick={() => type === "candidate" ? router.push('/signin') : window.open('https://www.youtube.com/watch?v=_wGI7HxQQHU', '_blank')}
                    sx={{
                      backgroundColor: "#ffffff",
                      color: "#383A3D",
                      border: "none",
