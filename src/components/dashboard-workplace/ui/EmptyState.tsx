 ...
 * Usage:
 *   <EmptyState
 *     icon={<CampaignOutlined sx={{ fontSize: 48 }} />}
 *     title="No campaigns yet"
 *     description="Create your first assessment campaign to get started."
 *     action={<Button variant="contained">Create Campaign</Button>}
 *   />
 */
