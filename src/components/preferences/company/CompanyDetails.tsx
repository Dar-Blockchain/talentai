...
const CompanyDetails = forwardRef(
  ({ preferences }: CompanyDetailsProps, ref) => {
    ...
    return (
      <Box sx={{ width: "100%" }}>
        ...
        >
          ...
          >
            This information helps us find candidates who are a great fit for
            your team.
          </Typography>
        </Box>
        ...
        >
          <Stack direction="column" spacing={3} sx={{ width: "100%" }}>
            ...
            {/* Company Size */}
            <Box sx={{ width: "100%" }}>
              <RequiredLabel label="Company Size" />
              <TextField
                select
                fullWidth
                variant="outlined"
