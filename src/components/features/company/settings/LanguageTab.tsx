        ...
        {LANGUAGE_OPTIONS.map((lang) => {
          ...
          return (
            ...
            >
              ...
              <img src={`https://flagcdn.com/w40/${lang.flag}.png`} srcSet={`https://flagcdn.com/w80/${lang.flag}.png 2x`} width={36} height={26} alt={lang.flag} style={{ borderRadius: 3, display: 'block' }} />
