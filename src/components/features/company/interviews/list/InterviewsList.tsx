...
import { Box, Typography, InputAdornment, TextField, Skeleton, Chip, Menu, MenuItem, Pagination } from "@mui/material";
  ...
  <Box>
    ...
    <Box sx={{ mb: 2 }}>
      <TextField
        ...
        InputProps={{ startAdornment: <InputAdornment position="start"><SearchOutlined sx={{ fontSize: 16, color: "#9CA3AF" }} /></InputAdornment> }}
