  ...
  return (
    <Box sx={sectionStyle}>
      ...
      {requirements && requirements.length > 0 && (
        <Box sx={{ mt: 2 }}>
          <Typography variant="subtitle2" sx={{ color: 'rgba(98, 111, 134, 1)', fontSize: '15px', fontWeight: 500 }}>Requirements</Typography>
          <List sx={listStyle}>
      ...
      {responsibilities && responsibilities.length > 0 && (
        <Box sx={{ mt: 2 }}>
          <Typography variant="subtitle2" sx={{ color: 'rgba(98, 111, 134, 1)', fontSize: '15px', fontWeight: 500 }}>Responsibilities</Typography>
          <List sx={listStyle}>
