    ...
    <Box sx={{ bgcolor: "#fff", borderRadius: "16px", border: "1px solid #E2E8F0", overflow: "hidden" }}>
      ...
      <Box sx={{ px: 2.5, pt: 2.25, pb: 2, borderBottom: "1px solid #F1F5F9" }}>
        ...
        <Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
            ...
            <Box>
              <Typography sx={{ fontSize: "0.95rem", fontWeight: 800, color: "#0F172A", lineHeight: 1.2 }}>Skills & Expertise</Typography>
              <Typography sx={{ fontSize: "0.65rem", color: "#94A3B8" }}>{techCount + softCount} skills total</Typography>
            </Box>
          </Box>
      ...
      <Box>
        <Box sx={{ px: 2.5, py: 1, display: "flex", alignItems: "center", gap: 0.75, bgcolor: "#F8FAFC", borderBottom: "1px solid #F1F5F9" }}>
          ...
          <Typography sx={{ fontSize: "0.7rem", fontWeight: 700, color: "#2563EB", textTransform: "uppercase", letterSpacing: "0.06em" }}>Technical</Typography>
      ...
      <Box sx={{ borderTop: "1px solid #E2E8F0" }}>
        <Box sx={{ px: 2.5, py: 1, display: "flex", alignItems: "center", gap: 0.75, bgcolor: "#F8FAFC", borderBottom: "1px solid #F1F5F9" }}>
          ...
          <Typography sx={{ fontSize: "0.7rem", fontWeight: 700, color: "#D97706", textTransform: "uppercase", letterSpacing: "0.06em" }}>Soft Skills</Typography>
