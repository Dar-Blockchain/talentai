...
const WorkplaceChat = dynamic(
  () => import("@/components/dashboard-workplace/WorkplaceChat"),
  { ssr: false, loading: Loader }
);
const WorkplaceJobPosts = dynamic(
  () => import("@/components/dashboard-workplace/WorkplaceJobPosts"),
  { ssr: false, loading: Loader }
);
