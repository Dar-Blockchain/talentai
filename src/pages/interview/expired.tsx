      ...
      >
        <Box
          sx={{
            ...
            height: 120,
            borderRadius: "50%",
            backgroundColor: "rgba(224, 62, 92, 0.1)",
            display: "flex",
            alignItems: "center",
            justifyContent: "center",
            mb: 4,
        ...
        >
          <TimerOff sx={{ fontSize: 56, color: "#E03E5C" }} />
        </Box>
        ...
        >
          {jobTitle
            ? `The job post "${jobTitle}" has expired and is no longer accepting applications.`
        ...
        >
          The hiring company has closed this position. Please check for other
