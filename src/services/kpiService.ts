...
export const kpiService = {
  ...
  fetchPostsStatusKPI: async (params: { page?: number; limit?: number } = {}) => {
    const res = await axiosInstance.get(`post/kpi/status-by-post${qs({ page: params.page ? String(params.page) : undefined, limit: params.limit ? String(params.limit) : undefined })}`);
    return {
