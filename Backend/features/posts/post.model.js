...
// Platform-wide admin aggregations (e.g. getCountsByDay) group/sort across
// all posts with no per-user filter, so the user-scoped compound index above
// can't help — they need createdAt indexed on its own.
