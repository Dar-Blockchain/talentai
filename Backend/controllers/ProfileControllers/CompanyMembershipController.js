...
module.exports.deleteMembership = async (req, res) => {
  try {
    ...
    const deleted = await CompanyMembershipService.deleteMembership(membershipId, companyOwnerId);
...
module.exports.updateMembershipRole = async (req, res) => {
  try {
    ...
    const updated = await CompanyMembershipService.updateMembershipRole(membershipId, role);
