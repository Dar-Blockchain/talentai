...
class CandidatePostStepProgressController {
  ...
  async createProgress(req, res) {
    try {
      const result = await candidatePostStepProgressService.createProgress(req.body);
  ...
  async getProgressByCandidateAndPost(req, res) {
    try {
      ...
      const result = await candidatePostStepProgressService.getProgressByCandidateAndPost(candidateId, postId);
  ...
  async getProgressByPost(req, res) {
    try {
      ...
      const result = await candidatePostStepProgressService.getProgressByPost(postId);
  ...
  async getProgressByStatus(req, res) {
    try {
      ...
      const result = await candidatePostStepProgressService.getProgressByStatus(status);
  ...
  async updateProgress(req, res) {
    try {
      const { id } = req.params;
      const result = await candidatePostStepProgressService.updateProgress(id, req.body);
  ...
  async updateProgressByCandidateAndPost(req, res) {
    try {
      const { candidateId, postId } = req.params;
      const result = await candidatePostStepProgressService.updateProgressByCandidateAndPost(candidateId, postId, req.body);
  ...
  async deleteProgressByCandidateAndPost(req, res) {
    try {
      const { candidateId, postId } = req.params;
      const result = await candidatePostStepProgressService.deleteProgressByCandidateAndPost(candidateId, postId);
  ...
  async upsertProgress(req, res) {
    try {
      const { candidateId, postId } = req.params;
      const result = await candidatePostStepProgressService.upsertProgress(candidateId, postId, req.body);
  ...
  async getProgressStatsByPost(req, res) {
    try {
      const { postId } = req.params;
      const result = await candidatePostStepProgressService.getProgressStatsByPost(postId);
  ...
  async getCompletedCandidatesByPost(req, res) {
    try {
      const { postId } = req.params;
      const result = await candidatePostStepProgressService.getCompletedCandidatesByPost(postId);
  ...
  async getInProgressCandidatesByPost(req, res) {
    try {
      const { postId } = req.params;
      const result = await candidatePostStepProgressService.getInProgressCandidatesByPost(postId);
