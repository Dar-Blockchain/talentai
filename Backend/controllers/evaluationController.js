...
/**
 * Controller: Analyze onboarding answers
 *
 * Délègue toute la logique métier au service `analyzeOnboardingAnswersService`.
 * Testé et validé manuellement: 20/08/2025 (fonctionne très bien)
 */
exports.analyzeOnboardingAnswers = async (req, res) => {
  try {
    ...
    const { analyzeOnboardingAnswersService } = require("../services/evaluationService");
    const result = await analyzeOnboardingAnswersService({ user, skill, questions });
