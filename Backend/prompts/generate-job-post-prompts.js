const getQuickPrompt = (description, companyLocation) =>
  `
    ...
    - If the job description explicitly mentions a spoken or written language (for example: English, French, Spanish), INCLUDE THAT LANGUAGE as the single soft skill. Assign the language a suitable "percentage" and "level". 
